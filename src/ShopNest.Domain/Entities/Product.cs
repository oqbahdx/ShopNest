...
public class Product : AuditableEntity, ISoftDeletable
{
    ...
    public decimal? CompareAtPrice    { get; set; }   // original price shown crossed out
    public decimal? CostPrice         { get; set; }   // internal cost, not exposed publicly
    ...
    public void RecalculateRating(IEnumerable<Review> approvedReviews)
    {
        ...
        AverageRating = list.Count == 0 ? 0 : Math.Round((decimal)list.Average(r => r.Rating), 2);
    }
}
